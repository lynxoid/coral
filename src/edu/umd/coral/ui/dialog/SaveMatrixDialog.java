...
public class SaveMatrixDialog extends JDialog implements ActionListener {
	...
	final public static String ADJ_LIST = "adjacency list";
	
	final public static String MATRIX = "matrix";
	
	final public static String DEFAULT_PATH = ".";
	
	final public static String [] SEPARATORS = {"\\t", ",", ";", "\\s"};
...
//		super("Save matrix", true);
	...
	private void initUI() {
		...
		p1.setAlignmentY(LEFT_ALIGNMENT);
//		p1.setLayout(new BoxLayout(p1, BoxLayout.Y_AXIS));
	...
	private void openFileBrowser() {
		...
		if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            try {
				this.tf.setText(directory.getCanonicalPath());
			} catch (IOException e) {
			}
        }
	}
